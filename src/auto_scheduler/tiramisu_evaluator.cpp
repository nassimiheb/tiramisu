...
//    parallelize_outermost_levels(ast.computations_list);
    ...
    {
        // Apply all the optimizations
        std::chrono::steady_clock::time_point apply_start = std::chrono::steady_clock::now();
        apply_optimizations(ast);
        std::chrono::steady_clock::time_point apply_end = std::chrono::steady_clock::now();
        std::cout << "#Apply optim time : " << std::chrono::duration_cast<std::chrono::milliseconds>(apply_start - apply_end).count() << " ms" << std::endl;


        std::chrono::steady_clock::time_point compile_start = std::chrono::steady_clock::now();
        ...
        std::cout << "#Compile time : " << std::chrono::duration_cast<std::chrono::milliseconds>(compile_end - compile_start).count() << " ms" << std::endl;
