...
extern "C" {
#endif
int function762468(halide_buffer_t *buf00, halide_buffer_t *buf01, halide_buffer_t *buf02, halide_buffer_t *buf03, halide_buffer_t *buf04);
#ifdef __cplusplus
}  // extern "C"
#endif
...
void declare_memory_usage(){
    setenv("MEM_SIZE", "514.0", true); // This value was set by the Code Generator
}
