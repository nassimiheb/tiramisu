#ifndef HALIDE__function_seidel2d_MEDIUM_o_h
#define HALIDE__function_seidel2d_MEDIUM_o_h
#include <stdint.h>
...
int function_seidel2d_MEDIUM(struct halide_buffer_t *_b_A_buffer) HALIDE_FUNCTION_ATTRS;
int function_seidel2d_MEDIUM_old_buffer_t(struct buffer_t *_b_A) HALIDE_FUNCTION_ATTRS;
