...
extern "C" {
#endif
int function_seidel2d_MEDIUM(halide_buffer_t *buf00);
#ifdef __cplusplus
}  // extern "C"
#endif
...
void declare_memory_usage(){
    setenv("MEM_SIZE", std::to_string((double)450*450*8/1024/1024).c_str(), true); // This value was set by the Code Generator
}
