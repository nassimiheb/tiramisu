    ...
    with torch.no_grad():
        try:
            while True:
                ...
                """
                sched_json = """
                {"mean_init" : {"shiftings" : null,"interchange_dims" : [],"transformation_matrices" : [["1"] ],"transformation_matrix" : ["1"],"tiling" : {},"unrolling_factor" : null,"parallelized_dim" : null, "skewing" : null}, "mean" : {"shiftings" : null,"interchange_dims" : [],"transformation_matrices" : [["1", "0", "0", "1"] , ["1", "0", "0", "-1"] ],"transformation_matrix" : ["1", "0", "0", "-1"],"tiling" : {},"unrolling_factor" : null,"parallelized_dim" : null, "skewing" : null}, "conv_init" : {"shiftings" : null,"interchange_dims" : [],"transformation_matrices" : [["1", "0", "0", "1"] ],"transformation_matrix" : ["1", "0", "0", "1"],"tiling" : {},"unrolling_factor" : null,"parallelized_dim" : null, "skewing" : null}, "cov" : {"shiftings" : null,"interchange_dims" : [],"transformation_matrices" : [["1", "0", "0", "0", "1", "0", "0", "0", "1"] ],"transformation_matrix" : ["1", "0", "0", "0", "1", "0", "0", "0", "1"],"tiling" : {},"unrolling_factor" : null,"parallelized_dim" : null, "skewing" : null}, "fusions" : null, "sched_str": "M({C0},1)M({C1},1,0,0,-1)M({C2},1,0,0,1)M({C3},1,0,0,0,1,0,0,0,1)", "tree_structure": {"roots" : [{"loop_name" : "jmean_init0","computations_list" : ["mean_init"],"child_list" : []},{"loop_name" : "lmean0","computations_list" : [],"child_list" : [{"loop_name" : "jmean1","computations_list" : ["mean"],"child_list" : []}]},{"loop_name" : "iconv_init0","computations_list" : [],"child_list" : [{"loop_name" : "jconv_init1","computations_list" : ["conv_init"],"child_list" : []}]},{"loop_name" : "icov0","computations_list" : [],"child_list" : [{"loop_name" : "jcov1","computations_list" : [],"child_list" : [{"loop_name" : "kcov2","computations_list" : ["cov"],"child_list" : []}]}]}]}}
                """
