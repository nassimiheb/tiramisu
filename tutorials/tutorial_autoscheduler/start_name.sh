...
rm -dr ${TIRAMISU_ROOT}/tutorials/tutorial_autoscheduler/$1/build/*

cd ${TIRAMISU_ROOT}/tutorials/tutorial_autoscheduler/$1/build
echo trying program auto_scheduler $1
sed -i -E "s/perform_autoscheduling=(false|true)/perform_autoscheduling=false/gi" ${TIRAMISU_ROOT}/tutorials/tutorial_autoscheduler/$1/generator.cpp
cmake ..
make
...
sed -i -E "s/perform_autoscheduling=(false|true)/perform_autoscheduling=true/gi" ${TIRAMISU_ROOT}/tutorials/tutorial_autoscheduler/$1/generator.cpp
cmake ..
make
