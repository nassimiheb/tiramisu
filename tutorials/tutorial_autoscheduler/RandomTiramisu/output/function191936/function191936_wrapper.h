...
extern "C" {
#endif
int function191936(halide_buffer_t *buf00, halide_buffer_t *buf01, halide_buffer_t *buf02);
#ifdef __cplusplus
}  // extern "C"
#endif
...
void declare_memory_usage(){
    setenv("MEM_SIZE", "1.0947265625", true); // This value was set by the Code Generator
}
