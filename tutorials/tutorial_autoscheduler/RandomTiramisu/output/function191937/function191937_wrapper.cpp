...
{
	double *c_buf00 = (double*)malloc(66*66*64* sizeof(double));
	parallel_init_buffer(c_buf00, 66*66*64, (double)69);
	Halide::Buffer<double> buf00(c_buf00, 66,66,64);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function191937(buf00.raw_buffer());
