...
{
	double *c_buf00 = (double*)malloc(514*514* sizeof(double));
	parallel_init_buffer(c_buf00, 514*514, (double)100);
	Halide::Buffer<double> buf00(c_buf00, 514,514);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function191935(buf00.raw_buffer());
