...
{
	double *c_buf00 = (double*)malloc(34*66*34* sizeof(double));
	parallel_init_buffer(c_buf00, 34*66*34, (double)16);
	Halide::Buffer<double> buf00(c_buf00, 34,66,34);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function191922(buf00.raw_buffer());
