...
{
	double *c_buf00 = (double*)malloc(32*32*128*32* sizeof(double));
	parallel_init_buffer(c_buf00, 32*32*128*32, (double)54);
	Halide::Buffer<double> buf00(c_buf00, 32,32,128,32);

	double *c_buf01 = (double*)malloc(32*64* sizeof(double));
	parallel_init_buffer(c_buf01, 32*64, (double)15);
	Halide::Buffer<double> buf01(c_buf01, 32,64);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function750060(buf00.raw_buffer(),buf01.raw_buffer());
