...
{
	double *c_buf00 = (double*)malloc(96*96*64* sizeof(double));
	parallel_init_buffer(c_buf00, 96*96*64, (double)38);
	Halide::Buffer<double> buf00(c_buf00, 96,96,64);

	double *c_buf01 = (double*)malloc(96*64*65* sizeof(double));
	parallel_init_buffer(c_buf01, 96*64*65, (double)71);
	Halide::Buffer<double> buf01(c_buf01, 96,64,65);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function750161(buf00.raw_buffer(),buf01.raw_buffer());
