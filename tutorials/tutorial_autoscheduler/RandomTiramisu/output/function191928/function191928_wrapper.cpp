...
{
	double *c_buf00 = (double*)malloc(128*192*64* sizeof(double));
	parallel_init_buffer(c_buf00, 128*192*64, (double)34);
	Halide::Buffer<double> buf00(c_buf00, 128,192,64);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function191928(buf00.raw_buffer());
