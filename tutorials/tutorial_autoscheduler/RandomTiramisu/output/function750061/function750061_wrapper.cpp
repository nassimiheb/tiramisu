...
{
	double *c_buf00 = (double*)malloc(128*16*64* sizeof(double));
	parallel_init_buffer(c_buf00, 128*16*64, (double)71);
	Halide::Buffer<double> buf00(c_buf00, 128,16,64);

	double *c_buf01 = (double*)malloc(64*16* sizeof(double));
	parallel_init_buffer(c_buf01, 64*16, (double)53);
	Halide::Buffer<double> buf01(c_buf01, 64,16);
    ...
    if (!nb_runs_dynamic){ 
        ...
        {  
            ...
            function750061(buf00.raw_buffer(),buf01.raw_buffer());
