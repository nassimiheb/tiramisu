...
extern "C" {
#endif
int function191924(halide_buffer_t *buf00, halide_buffer_t *buf01, halide_buffer_t *buf02);
#ifdef __cplusplus
}  // extern "C"
#endif
...
void declare_memory_usage(){
    setenv("MEM_SIZE", "0.0322418212890625", true); // This value was set by the Code Generator
}
