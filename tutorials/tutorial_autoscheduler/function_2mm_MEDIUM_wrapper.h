...
extern "C" {
#endif
int function_2mm_MEDIUM(halide_buffer_t *buf00, halide_buffer_t *buf01, halide_buffer_t *buf02, halide_buffer_t *buf03);
#ifdef __cplusplus
}  // extern "C"
#endif
...
void declare_memory_usage(){
    setenv("MEM_SIZE", std::to_string((double)(0)*8/1024/1024).c_str(), true); // This value was set by the Code Generator
}
